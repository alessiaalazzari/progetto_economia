...
namespace Prova_1_econmics
{
    public partial class Nuovo_progetto : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            salva.Filter = "BPAL File|*.BPAL|All Files|*.*";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            listBox3.Items.Add("Totale | " + salvo_totale.ToString() + " | " + System.Math.Round(prezzo_vendita_totale, 2).ToString() + " | " + (totale_valore_percentuali*100).ToString()+"%");
        ...
        public void carica_file()
        {
            ...
            apri.Filter = "BPAL File|*.BPAL|All Files|*.*";
